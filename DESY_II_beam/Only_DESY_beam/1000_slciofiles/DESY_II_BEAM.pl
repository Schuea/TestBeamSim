...
my $homeDirectory="DESY_II_beam/Only_DESY_beam/1000_slciofiles"; #TO BE ADJUSTED!!!
...
my $lcddfile="DESY_II_beam.lcdd"; #TO BE ADJUSTED!!!
#my $inputfile="Hvalues_for_macros_1.txt";  #TO BE ADJUSTED!!!
my $slciofile="DESY_II_beam_"; #TO BE ADJUSTED!!!
my $rootfile="DESY_II_beam_";#TO BE ADJUSTED!!!

my $macrofilename="DESY_II_";        
my $jobfilename_="Job_beam_";
...
#	if($5==0) {next;}
	...
	print MACROFILE "/gps/pos/sigma_x 1.53 mm","\n";
	print MACROFILE "/gps/pos/sigma_y 0.753 mm","\n";
...
#	print MACROFILE "/gps/ene/mono ",$6," GeV","\n";
	...
	print MACROFILE "/gps/ene/sigma 6.17249 MeV","\n";
