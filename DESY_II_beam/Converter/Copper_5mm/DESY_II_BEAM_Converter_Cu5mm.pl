...
my $homeDirectory="DESY_II_beam/Converter/Copper_5mm"; #TO BE ADJUSTED!!!
...
my $lcddfile="Converter_Copper_5mm.lcdd"; #TO BE ADJUSTED!!!
...
my $macrofilename="Cu5mm_";        
my $jobfilename_="Job_Cu5mm_";
