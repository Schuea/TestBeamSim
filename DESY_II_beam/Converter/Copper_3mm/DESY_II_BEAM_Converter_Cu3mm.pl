...
my $homeDirectory="DESY_II_beam/Converter/Copper_3mm"; #TO BE ADJUSTED!!!
...
my $lcddfile="Converter_Copper_3mm.lcdd"; #TO BE ADJUSTED!!!
...
my $macrofilename="Cu3mm_";        
my $jobfilename_="Job_Cu3mm_";
