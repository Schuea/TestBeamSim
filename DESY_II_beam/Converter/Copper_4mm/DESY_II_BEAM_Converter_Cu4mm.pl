...
my $homeDirectory="DESY_II_beam/Converter/Copper_4mm"; #TO BE ADJUSTED!!!
...
my $lcddfile="Converter_Copper_4mm.lcdd"; #TO BE ADJUSTED!!!
...
my $macrofilename="Cu4mm_";        
my $jobfilename_="Job_Cu4mm_";
