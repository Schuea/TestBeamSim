...
my $homeDirectory="DESY_II_beam/Collimator"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_Converter_Magnet_COLLIMATOR.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="Pipe_Converter_Magnet_Collimator_"; #TO BE ADJUSTED!!!
my $rootfile="Pipe_Converter_Magnet_Collimator_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_Collimator_";        
my $jobfilename_="MacroJob_Collimator";
my $steeringfile_="Sim_Steeringfile_Collimator";
my $submitfile="SubmitJobs_Collimator";
my $marlinexe="MarlinExe_Collimator";
my $slicexe="SlicExe_Collimator";

my $eventnumberfile="List_of_target_numbers_of_Events";
my $checkexe="Check_numbers_of_Events_Collimator";

my $macrosDirectory="Macros_Collimator";
my $jobDirectory="JobsMacro_Collimator";
my $steeringDirectory="Steeringfiles_Collimator";
my $slcioDirectory="NEWslcioFiles_Collimator";
my $ROOTfilesDirectory="rootFiles_Collimator";
