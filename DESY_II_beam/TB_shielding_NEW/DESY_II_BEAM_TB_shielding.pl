...
my $homeDirectory="DESY_II_beam/TB_shielding_NEW"; #TO BE ADJUSTED!!!
...
my $geometry_file="Pipe_LeadShielding_wo_SideBlock.gdml"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_real_sized_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="TB_shielding_"; #TO BE ADJUSTED!!!
my $rootfile="TB_shielding_";#TO BE ADJUSTED!!!

my $macrofilename="TB_shielding_";        
my $jobfilename_="Job_TB_shielding_";
...
while(<INPUTFILE>)
{
	...
	print JOBFILE $SlicPATH," -g ",$geometry_file," -m ./",$macrosDirectory,"/",$macrofilename,"\n";
	close(JOBFILE);
