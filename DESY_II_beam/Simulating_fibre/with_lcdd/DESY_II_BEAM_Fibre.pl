...
my $homeDirectory="DESY_II_beam/Simulating_fibre/with_lcdd"; #TO BE ADJUSTED!!!
...
my $lcddfile="Fibre_at0_05cm_25mu_wo_readout.lcdd"; #TO BE ADJUSTED!!!
#my $inputfile="Hvalues_for_macros_1.txt";  #TO BE ADJUSTED!!!
my $slciofile="Fibre_"; #TO BE ADJUSTED!!!
my $rootfile="Fibre_";#TO BE ADJUSTED!!!

my $macrofilename="Fibre_";        
my $jobfilename_="Job_Fibre_";
