...
my $homeDirectory="DESY_II_beam/TB_magnet"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_AluWindow_Converter_MAGNET_wo_Collimator.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="Pipe_AluWindow_Converter_MAGNET_wo_Collimator_"; #TO BE ADJUSTED!!!
my $rootfile="Pipe_AluWindow_Converter_MAGNET_wo_Collimator_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_wo_Collimator_";        
my $jobfilename_="MacroJob_wo_Collimator";
my $steeringfile_="Sim_Steeringfile_wo_Collimator";
my $submitfile="SubmitJobs_wo_Collimator";
my $marlinexe="MarlinExe_wo_Collimator";
my $slicexe="SlicExe_wo_Collimator";

my $eventnumberfile="List_of_target_numbers_of_Events";
my $checkexe="Check_numbers_of_Events_wo_Collimator";

my $macrosDirectory="Macros_wo_Collimator";
my $jobDirectory="JobsMacro_wo_Collimator";
my $steeringDirectory="Steeringfiles_wo_Collimator";
my $slcioDirectory="NEWslcioFiles_wo_Collimator";
my $ROOTfilesDirectory="rootFiles_wo_Collimator";
