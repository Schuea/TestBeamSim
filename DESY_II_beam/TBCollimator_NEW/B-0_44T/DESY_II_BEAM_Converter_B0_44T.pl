...
my $homeDirectory="DESY_II_beam/TBCollimator_NEW/B-0_44T"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_LeadShielding_Converter_Magnet_Collimator_WALL_TBCollimator_B-0_44T.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_real_sized_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="TBCollimator_"; #TO BE ADJUSTED!!!
my $rootfile="TBCollimator_";#TO BE ADJUSTED!!!

my $macrofilename="B-0_44T_";        
my $jobfilename_="Job_B-0_44T_";
...
while(<INPUTFILE>)
{
	...
	print STEERINGFILE "<parameter name=\"InputCollectionName5\" type=\"string\" lcioInType=\"SimTrackerHit\"> PhantomTrackerHits3 </parameter>","\n";
	print STEERINGFILE "<parameter name=\"InputCollectionName6\" type=\"string\" lcioInType=\"SimTrackerHit\"> PhantomTrackerHits4 </parameter>","\n";
	print STEERINGFILE "<parameter name=\"InputCollectionName7\" type=\"string\" lcioInType=\"SimTrackerHit\"> PhantomTrackerHits5 </parameter>","\n";
	print STEERINGFILE "<parameter name=\"InputCollectionName8\" type=\"string\" lcioInType=\"SimTrackerHit\"> PhantomTrackerHits6 </parameter>","\n";
