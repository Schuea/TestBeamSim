...
my $homeDirectory="DESY_II_beam/Pipe_Air"; #TO BE ADJUSTED!!!
...
my $geometry_file="PipeAir.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_real_sized_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="Pipe_Air_"; #TO BE ADJUSTED!!!
my $rootfile="Pipe_Air_";#TO BE ADJUSTED!!!

my $macrofilename="Pipe_Air_";        
my $jobfilename_="Job_Pipe_Air_";
...
while(<INPUTFILE>)
{
	...
	print MACROFILE "/lcdd/url ./",$geometry_file,"\n";
