...
my $homeDirectory="DESY_II_beam/Collimator_TB_area"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_Converter_Magnet_Collimator_CollimatorTBarea.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="Pipe_Converter_Magnet_CollimatorTBarea_"; #TO BE ADJUSTED!!!
my $rootfile="Pipe_Converter_Magnet_CollimatorTBarea_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_CollimatorTBarea_";        
my $jobfilename_="MacroJob_CollimatorTBarea";
my $steeringfile_="Sim_Steeringfile_CollimatorTBarea";
my $submitfile="SubmitJobs_CollimatorTBarea";
my $marlinexe="MarlinExe_CollimatorTBarea";
my $slicexe="SlicExe_CollimatorTBarea";

my $eventnumberfile="List_of_target_numbers_of_Events";
my $checkexe="Check_numbers_of_Events_CollimatorTBarea";

my $macrosDirectory="Macros_CollimatorTBarea";
my $jobDirectory="JobsMacro_CollimatorTBarea";
my $steeringDirectory="Steeringfiles_CollimatorTBarea";
my $slcioDirectory="NEWslcioFiles_CollimatorTBarea";
my $ROOTfilesDirectory="rootFiles_CollimatorTBarea";
