...
my $homeDirectory="DESY_II_beam/Collimator_NEW/B-0_44T"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_LeadShielding_Converter_Magnet_Collimator.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_real_sized_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="Collimator_"; #TO BE ADJUSTED!!!
my $rootfile="Collimator_";#TO BE ADJUSTED!!!
