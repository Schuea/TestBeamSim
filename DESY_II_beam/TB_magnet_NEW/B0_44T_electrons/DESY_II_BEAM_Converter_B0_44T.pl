...
my $homeDirectory="DESY_II_beam/TB_magnet_NEW/B0_44T_electrons"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_LeadShielding_Converter_Magnet.lcdd"; #TO BE ADJUSTED!!!
...
my $macrofilename="B0_44T_";        
my $jobfilename_="Job_B0_44T_";
