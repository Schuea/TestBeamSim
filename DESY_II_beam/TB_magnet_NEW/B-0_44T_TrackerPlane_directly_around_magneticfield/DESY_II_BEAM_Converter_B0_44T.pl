...
my $homeDirectory="DESY_II_beam/TB_magnet_NEW/B-0_44T_TrackerPlane_directly_around_magneticfield"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_LeadShielding_Converter_Magnet_B-0_44T.lcdd"; #TO BE ADJUSTED!!!
