...
my $homeDirectory="DESY_II_beam/Split_geometry_before_magnet"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_Lead_Converter_WO_FIBRE.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="Pipe_Lead_Converter_WO_FIBRE_"; #TO BE ADJUSTED!!!
my $rootfile="Pipe_Lead_Converter_WO_FIBRE_";#TO BE ADJUSTED!!!
