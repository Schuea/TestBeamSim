...
my $homeDirectory="DESY_II_beam/Split_geometry_before_magnet/MagnetPart"; #TO BE ADJUSTED!!!
...
my $lcddfile="Only_magnet.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_macros_Split_geometry_before_magnet_ELECTRONS.txt";  #TO BE ADJUSTED!!!
my $slciofile="Particles_through_magnet_"; #TO BE ADJUSTED!!!
my $rootfile="Particles_through_magnet_";#TO BE ADJUSTED!!!

my $macrofilename="Particle_source_";        
my $jobfilename_="Job";
my $steeringfile_="Steeringfile";
my $submitfile="SubmitJobs_MAGNET";
my $marlinexe="MarlinExe_MAGNET";
my $slicexe="SlicExe_MAGNET";

my $eventnumberfile="List_of_target_numbers_of_Events_MAGNET";
my $checkexe="Check_numbers_of_Events_MAGNET";

my $macrosDirectory="Macros_MAGNET";
my $jobDirectory="Jobs_MAGNET";
my $steeringDirectory="Steeringfiles_MAGNET";
my $slcioDirectory="NEWslcioFiles_MAGNET";
my $ROOTfilesDirectory="rootFiles_MAGNET";
...
#	if($i==1){
	...
	print SUBMITFILE "qsub -cwd -o Output/ -e Error/ -l distro=\"sld6\" -q default.q ./",$jobDirectory,"/",$jobfilename,"\n";
	close(SUBMITFILE);
...
#	if($i==1){
	...
	print CHECKEXE "lcio_event_counter ",$slcioDirectory,"/",$lciofilename,">> List_of_Event_numbers_MAGNET.txt","\n";
	close(CHECKEXE);
