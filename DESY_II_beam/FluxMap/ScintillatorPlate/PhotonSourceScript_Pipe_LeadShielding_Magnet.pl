...
my $homeDirectory="DESY_II_beam/FluxMap/ScintillatorPlate"; #TO BE ADJUSTED!!!
...
my $lcddfile="ScintillatorPlate_MAGNET_0_59T_wo_Collimator.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_DESY_II_beam_macros.txt";  #TO BE ADJUSTED!!!
my $slciofile="ScintillatorPlate_MAGNET_0_59T_wo_Collimator_"; #TO BE ADJUSTED!!!
my $rootfile="ScintillatorPlate_Converter_MAGNET_0_59T_wo_Collimator_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_wo_Collimator_0_59T_";        
my $jobfilename_="MacroJob_wo_Collimator_0_59T";
my $steeringfile_="Sim_Steeringfile_wo_Collimator_0_59T";
my $submitfile="SubmitJobs_wo_Collimator_0_59T";
my $marlinexe="MarlinExe_wo_Collimator_0_59T";
my $slicexe="SlicExe_wo_Collimator_0_59T";

my $eventnumberfile="List_of_target_numbers_of_Events";
my $checkexe="Check_numbers_of_Events_wo_Collimator_0_59T";

my $macrosDirectory="Macros_ScintillatorPlate_0_59T";
my $jobDirectory="JobsMacro_ScintillatorPlate_0_59T";
my $steeringDirectory="Steeringfiles_ScintillatorPlate_0_59T";
my $slcioDirectory="NEWslcioFiles_ScintillatorPlate_0_59T";
my $ROOTfilesDirectory="rootFiles_ScintillatorPlate_0_59T";
