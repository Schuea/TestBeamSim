...
my $lcddfile="Converter_at2380cm_with_air.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_macros_different_binning_2G.txt";  #TO BE ADJUSTED!!!
my $slciofile="Converter_at2380cm_with_air_2G_"; #TO BE ADJUSTED!!!
my $rootfile="Sim_Converter_at2380cm_with_air_2G_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_";        
