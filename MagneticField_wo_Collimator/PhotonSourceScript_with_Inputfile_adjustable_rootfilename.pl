...
my $homeDirectory="MagneticField_wo_Collimator"; #TO BE ADJUSTED!!!
...
my $macrofilename="Photonsource_wo_Collimator_2000gauss_";        
my $jobfilename_="MacroJob_wo_Collimator_2000gauss";
my $steeringfile_="Sim_Steeringfile_wo_Collimator_2000gauss";
my $submitfile="SubmitJobs_wo_Collimator_2000gauss";
my $marlinexe="MarlinExe_wo_Collimator_2000gauss";
my $slicexe="SlicExe_wo_Collimator_2000gauss";

my $eventnumberfile="List_of_target_numbers_of_Events";
my $checkexe="Check_numbers_of_Events_wo_Collimator_2000gauss";

my $macrosDirectory="Macros_wo_Collimator_2000gauss";
my $jobDirectory="JobsMacro_wo_Collimator_2000gauss";
my $steeringDirectory="Steeringfiles_wo_Collimator_2000gauss";
my $slcioDirectory="NEWslcioFiles_wo_Collimator_2000gauss";
my $ROOTfilesDirectory="rootFiles_wo_Collimator_2000gauss";
