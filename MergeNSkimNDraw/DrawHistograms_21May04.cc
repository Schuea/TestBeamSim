...
void DrawingMacro(string name){
	...
	TH1F * EnergyHisto_Kaons = new TH1F("E_Kaons","Energy distribution of kaons existing behind converter",30,0,1);
	EnergyHisto_Kaons->SetLineColor(4);
	EnergyHisto_Kaons->GetXaxis()->SetTitle("Energy/GeV");
	EnergyHisto_Kaons->GetXaxis()->CenterTitle();
	TH1F * EnergyHisto_KaonsPlus = new TH1F("E_KaonsPlus","Energy distribution of positive kaons existing behind converter",30,0,1);
	EnergyHisto_KaonsPlus->SetLineColor(2);
	EnergyHisto_KaonsPlus->GetXaxis()->SetTitle("Energy/GeV");
	EnergyHisto_KaonsPlus->GetXaxis()->CenterTitle();
	...
	T->Draw("Energy >>+ E_Positrons","Particle_ID==-11","same");
