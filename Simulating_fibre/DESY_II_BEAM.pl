...
my $homeDirectory="Simulating_fibre"; #TO BE ADJUSTED!!!
...
my $lcddfile="Fibre_at0_05cm_25mu.lcdd"; #TO BE ADJUSTED!!!
#my $inputfile="Hvalues_for_macros_1.txt";  #TO BE ADJUSTED!!!
my $slciofile="Fibre_at0_05cm_25mu_"; #TO BE ADJUSTED!!!
my $rootfile="Fibre_at0_05cm_25mu_";#TO BE ADJUSTED!!!

my $macrofilename="DESY_II_";        
my $jobfilename_="Job_FIBRE";
my $steeringfile_="Steeringfile";
...
#	if($5==0) {next;}
	...
	my $macrofilename=sprintf("%s%i%s",$macrofilename,$i,".macro");
	my $lciofilename=sprintf("%s%i%s",$slciofile,$i,".slcio");
	...
	print MACROFILE "/generator/select gps","\n";
	print MACROFILE "/gps/particle e-","\n";
	print MACROFILE "/gps/pos/type Beam","\n";
	print MACROFILE "/gps/pos/halfx 350 nm","\n";
	print MACROFILE "/gps/pos/sigma_x 10 nm","\n";
	print MACROFILE "/gps/pos/halfy 35 nm","\n";
	print MACROFILE "/gps/pos/sigma_y 1 nm","\n";
#	print MACROFILE "/gps/pos/centre ",$2," ",$3," 0","\n";
	print MACROFILE "/gps/pos/centre 0 0 0 cm","\n";
	print MACROFILE "/gps/direction 0. 0. 1","\n";
	print MACROFILE "/gps/ene/type Gauss ","\n";
#	print MACROFILE "/gps/ene/mono ",$6," GeV","\n";
	print MACROFILE "/gps/ene/mono 6.3 GeV","\n";
	print MACROFILE "/gps/ene/sigma 7.56 MeV","\n";
