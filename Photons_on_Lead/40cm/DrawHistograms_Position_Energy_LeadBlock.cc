...
//	TH1::SetDefaultSumw2();
	...
	TH2F * Position_05GeV_Photons = new TH2F("Posi_05_Photons","Position of 0.5GeV photons behind lead block with 40cm thickness",200,-20,20,200,-20,20);
	...
	TH2F * Position_5GeV_Photons = new TH2F("Posi_5_Photons","Position of 5GeV photons behind lead block with 40cm thickness",200,-20,20,200,-20,20);
	...
	TH2F * Position_6_3GeV_Photons = new TH2F("Posi_6_3_Photons","Position of 6.3GeV photons behind lead block with 40cm thickness",200,-20,20,200,-20,20);
	...
	TH1F * EnergyHisto_05GeV_ElePhot = new TH1F("Energy_05_ElePhot","Energy distribution of particles behind lead block with 40cm thickness. Initial photons with 0.5GeV",100,0,2);
	...
	TH1F * EnergyHisto_05GeV_ProtNeut = new TH1F("Energy_05_ProtNeut","Energy distribution of particles behind lead block with 40cm thickness. Initial photons with 0.5GeV",100,0,2);
	...
	TH1F * EnergyHisto_5GeV_ElePhot = new TH1F("Energy_5_ElePhot","Energy distribution of particles behind lead block with 40cm thickness. Initial photons with 5.0GeV",100,0,2);
	...
	TH1F * EnergyHisto_5GeV_ProtNeut = new TH1F("Energy_5_ProtNeut","Energy distribution of particles behind lead block with 40cm thickness. Initial photons with 5.0GeV",100,0,2);
	...
	TH1F * EnergyHisto_6_3GeV_ElePhot = new TH1F("Energy_6_3_ElePhot","Energy distribution of particles behind lead block with 40cm thickness. Initial photons with 6.3GeV",100,0,2);
	...
	TH1F * EnergyHisto_6_3GeV_ProtNeut = new TH1F("Energy_6_3_ProtNeut","Energy distribution of particles behind lead block with 40cm thickness. Initial photons with 6.3GeV",100,0,2);
	...
	TH1F * MomentumHisto_05GeV_ElePhot = new TH1F("Momentum_05_ElePhot","Momentum distribution of particles behind lead block with 40cm thickness. Initial photons with 0.5GeV",100,0,2);
	...
	TH1F * MomentumHisto_05GeV_ProtNeut = new TH1F("Momentum_05_ProtNeut","Momentum distribution of particles behind lead block with 40cm thickness. Initial photons with 0.5GeV",100,0,2);
	...
	TH1F * MomentumHisto_5GeV_ElePhot = new TH1F("Momentum_5_ElePhot","Momentum distribution of particles behind lead block with 40cm thickness. Initial photons with 5.0GeV",100,0,2);
	...
	TH1F * MomentumHisto_5GeV_ProtNeut = new TH1F("Momentum_5_ProtNeut","Momentum distribution of particles behind lead block with 40cm thickness. Initial photons with 5.0GeV",100,0,2);
	...
	TH1F * MomentumHisto_6_3GeV_ElePhot = new TH1F("Momentum_6_3_ElePhot","Momentum distribution of particles behind lead block with 40cm thickness. Initial photons with 6.3GeV",100,0,2);
	...
	TH1F * MomentumHisto_6_3GeV_ProtNeut = new TH1F("Momentum_6_3_ProtNeut","Momentum distribution of particles behind lead block with 40cm thickness. Initial photons with 6.3GeV",100,0,2);
	...
	TCanvas * Energy_Canvas = new TCanvas("40cm_Energy_Canvas");
	TCanvas * Momentum_Canvas = new TCanvas("40cm_Momentum_Canvas");
	TCanvas * Position_Canvas = new TCanvas("40cm_Position_Canvas");
