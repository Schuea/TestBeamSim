...
my $homeDirectory="effect_of_2380cm_air"; #TO BE ADJUSTED!!!
...
my $lcddfile="2380cm_nothing.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_macros_different_binning_2G.txt";  #TO BE ADJUSTED!!!
my $slciofile="2380cm_nothing_2G_"; #TO BE ADJUSTED!!!
my $rootfile="Sim_2380cm_nothing_2G_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_2380cm_nothing_2G";        
my $jobfilename_="MacroJob_2380cm_nothing_2G";
my $steeringfile_="Sim_Steeringfile_2380cm_nothing_2G";
my $submitfile="SubmitJobs_2380cm_nothing_2G";
my $marlinexe="MarlinExe_2380cm_nothing_2G";
my $slicexe="SlicExe_2380cm_nothing_2G";

my $eventnumberfile="List_of_target_numbers_of_Events_nothing";
my $checkexe="Check_numbers_of_Events_nothing";

my $macrosDirectory="Macros_2380cm_nothing_2G";
my $jobDirectory="JobsMacro_2380cm_nothing_2G";
my $steeringDirectory="Steeringfiles_2380cm_nothing_2G";
my $slcioDirectory="NEWslcioFiles_2380cm_nothing_2G";
my $ROOTfilesDirectory="rootFiles_2380cm_nothing_2G";
...
while(<INPUTFILE>)
{
	...
	print MARLINEXE "Marlin ",$steeringDirectory,"/",$steeringfile,$i-1,".xml","\n";
