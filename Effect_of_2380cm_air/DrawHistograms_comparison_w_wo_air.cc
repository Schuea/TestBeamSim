...
void DrawingMacro(string outputname,string name1, string name2){
	...
	TH2F * PositionMap_Photons = new TH2F("Position_Photons","Position of photons at z=2380cm",500,-70,70,500,-70,70);
	...
	TH2F * PositionMap_Electrons = new TH2F("Position_Electrons","Position of electrons at z=2380cm",500,-70,70,500,-70,70);
	PositionMap_Electrons->GetXaxis()->SetTitle("x-position (mm)");
	PositionMap_Electrons->GetXaxis()->CenterTitle();
	PositionMap_Electrons->GetYaxis()->SetTitle("y-position (mm)");
	PositionMap_Electrons->GetYaxis()->CenterTitle();
	TH2F * PositionMap_Protons = new TH2F("Position_Protons","Position of protons at z=2380cm",200,-70,70,200,-70,70);
	PositionMap_Protons->GetXaxis()->SetTitle("x-position (mm)");
	PositionMap_Protons->GetXaxis()->CenterTitle();
	PositionMap_Protons->GetYaxis()->SetTitle("y-position (mm)");
	...
	TLegend * Legend3 = new TLegend(0.4,0.6,0.73,0.8);
	...
	Legend3->AddEntry(EnergyHisto_DecayedInTracker_AIR_Photons,"Converted photons, in air","l");
	Legend3->Draw();
