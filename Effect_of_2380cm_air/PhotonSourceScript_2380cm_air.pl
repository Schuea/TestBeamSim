...
my $lcddfile="2380cm_air.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_macros_different_binning_2G.txt";  #TO BE ADJUSTED!!!
my $slciofile="2380cm_air_2G_"; #TO BE ADJUSTED!!!
my $rootfile="Sim_2380cm_air_2G_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_2G_";        
my $jobfilename_="MacroJob_2G";
my $steeringfile_="Sim_Steeringfile_2G";
my $submitfile="SubmitJobs_2G";
my $marlinexe="MarlinExe_2G";
my $slicexe="SlicExe_2G";

my $eventnumberfile="List_of_target_numbers_of_Events";
my $checkexe="Check_numbers_of_Events";

my $macrosDirectory="Macros_2G";
my $jobDirectory="JobsMacro_2G";
my $steeringDirectory="Steeringfiles_2G";
my $slcioDirectory="NEWslcioFiles_2G";
my $ROOTfilesDirectory="rootFiles_2G";
