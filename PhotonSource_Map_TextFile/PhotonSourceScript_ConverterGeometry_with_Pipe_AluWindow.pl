...
my $lcddfile="Pipe_AluWindow_Converter_at2380cm_with_air.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_macros_different_binning_2G.txt";  #TO BE ADJUSTED!!!
my $slciofile="Pipe_AluWindow_Air_Converter_2G_"; #TO BE ADJUSTED!!!
my $rootfile="Pipe_AluWindow_Air_Converter_2G_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_Pipe_";        
my $jobfilename_="MacroJob_Pipe";
my $steeringfile_="Sim_Steeringfile_Pipe";
my $submitfile="SubmitJobs_Pipe";
my $marlinexe="MarlinExe_Pipe";
my $slicexe="SlicExe_Pipe";

my $eventnumberfile="List_of_target_numbers_of_Events_Pipe";
my $checkexe="Check_numbers_of_Events_Pipe";

my $macrosDirectory="Macros_Pipe";
my $jobDirectory="JobsMacro_Pipe";
my $steeringDirectory="Steeringfiles_Pipe";
my $slcioDirectory="NEWslcioFiles_Pipe";
my $ROOTfilesDirectory="rootFiles_Pipe";
