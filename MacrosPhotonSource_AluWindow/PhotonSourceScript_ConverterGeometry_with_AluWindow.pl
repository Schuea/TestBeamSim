...
my $homeDirectory="MacrosPhotonSource_2G"; #TO BE ADJUSTED!!!
...
my $lcddfile="AluWindow_Converter_at1980cm_with_air.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_macros_AngleCut.txt";  #TO BE ADJUSTED!!!
my $slciofile="AluWindow_Air_Converter_2G_"; #TO BE ADJUSTED!!!
my $rootfile="AluWindow_Air_Converter_2G_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_AluWindow_";        
my $jobfilename_="MacroJob_AluWindow";
my $steeringfile_="Sim_Steeringfile_AluWindow";
my $submitfile="SubmitJobs_AluWindow";
my $marlinexe="MarlinExe_AluWindow";
my $slicexe="SlicExe_AluWindow";

my $eventnumberfile="List_of_target_numbers_of_Events_AluWindow";
my $checkexe="Check_numbers_of_Events_AluWindow";

my $macrosDirectory="Macros_AluWindow";
my $jobDirectory="JobsMacro_AluWindow";
my $steeringDirectory="Steeringfiles_AluWindow";
my $slcioDirectory="NEWslcioFiles_AluWindow";
my $ROOTfilesDirectory="rootFiles_AluWindow";
