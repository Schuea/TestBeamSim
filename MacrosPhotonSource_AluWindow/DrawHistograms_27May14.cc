...
void DrawingMacro(string name){
	...
	for(int i = 1; i < 13; ++i){
		...
		savetext << histoname.str() << "_" << angle << "degree_" << angle+angleinterval <<"degree_AluWindow.eps";
		savetext2 << histoname.str() << "_" << angle << "degree_" << angle+angleinterval <<"degree_AluWindow.C";
...
//	EnergyHisto_Positrons->Scale(1.0/(EnergyHisto_Positrons->Integral()));
	...
	E_Canvas_Electrons->Print((canvasname+"_AluWindow.eps").c_str());	
	E_Canvas_Electrons->Print((canvasname+"_AluWindow.C").c_str());	
...
//	EnergyHisto_PionsPlus->SetStats(kFALSE);
	...
	E_Canvas_PhotonsMuonsKaons->Print((canvasname2+"_AluWindow.eps").c_str());	
	E_Canvas_PhotonsMuonsKaons->Print((canvasname2+"_AluWindow.C").c_str());	
...
//	EnergyHisto_ParentPhoton->SetStats(kFALSE);
	...
	CompareSimStatus_Canvas->Print((canvasname3+"_AluWindow.eps").c_str());
	CompareSimStatus_Canvas->Print((canvasname3+"_AluWindow.C").c_str());
