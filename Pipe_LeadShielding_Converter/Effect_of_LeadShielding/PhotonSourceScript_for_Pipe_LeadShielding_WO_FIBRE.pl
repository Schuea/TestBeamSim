...
my $homeDirectory="Pipe_LeadShielding_Converter/Effect_of_LeadShielding"; #TO BE ADJUSTED!!!
...
my $lcddfile="Pipe_LeadShielding_WO_FIBRE.lcdd"; #TO BE ADJUSTED!!!
my $inputfile="Hvalues_for_macros_different_binning_2G.txt";  #TO BE ADJUSTED!!!
my $slciofile="Pipe_Lead_WO_FIBRE_"; #TO BE ADJUSTED!!!
my $rootfile="Pipe_Lead_WO_FIBRE_";#TO BE ADJUSTED!!!

my $macrofilename="Photonsource_WO_FIBRE_";        
my $jobfilename_="Job_WO_FIBRE";
my $steeringfile_="Steeringfile_WO_FIBRE";
my $submitfile="SubmitJobs_WO_FIBRE";
my $marlinexe="MarlinExe_WO_FIBRE";
my $slicexe="SlicExe_WO_FIBRE";

my $eventnumberfile="List_of_target_numbers_of_Events_WO_FIBRE";
my $checkexe="Check_numbers_of_Events_WO_FIBRE";

my $macrosDirectory="Macros_WO_FIBRE";
my $jobDirectory="Jobs_WO_FIBRE";
my $steeringDirectory="Steeringfiles_WO_FIBRE";
my $slcioDirectory="NEWslcioFiles_WO_FIBRE";
my $ROOTfilesDirectory="rootFiles_WO_FIBRE";
...
while(<INPUTFILE>)
{
	...
	my $macrofilename=sprintf("%s%5.5i%s",$macrofilename,$i,".macro");
	my $lciofilename=sprintf("%s%5.5i%s",$slciofile,$i,".slcio");
...
#	print MACROFILE "/run/beamOn ",$events_per_job,"\n";
	...
	my $jobfilename=sprintf("%s%i",$jobfilename_,$i);
	...
	my $steeringfile=sprintf("%s%i%s",$steeringfile_,$i,".xml");
	...
	print STEERINGFILE "<parameter name=\"MaxRecordNumber\" value=\"2000000001\" />","\n";
...
#	if($i==1){
	...
	print MARLINEXE "Marlin ",$steeringDirectory,"/",$steeringfile_,$i,".xml","\n";
        print MARLINEXE "mv Sim.root ",$rootfile,$i,".root","\n";
        print MARLINEXE "mv ",$rootfile,$i,".root ",$ROOTfilesDirectory,"\n";
	close(MARLINEXE);
...
#	if($i==1){
	...
	print CHECKEXE "lcio_event_counter ",$slcioDirectory,"/",$lciofilename,">> List_of_Event_numbers_WO_FIBRE.txt","\n";
	close(CHECKEXE);
